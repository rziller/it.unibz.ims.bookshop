...
public class SearchController {
    ...
    @GetMapping("/search")
    String getSearchResultView(@RequestParam Map<String, String> queryParameters,
                   HttpServletRequest request,
                   HttpSession session,
                   Model model) {
        Page<Product> products = productService.findSearchResult(queryParameters, request);
